...
namespace MadsKristensen.EditorExtensions.Html
{
    ...
    internal class ImageQuickInfo : IQuickInfoSource
    {
        ...
        {
            return GetFullUrl(text, sourceBuffer.GetFileName() ?? ZenCodingPackage.DTE.ActiveDocument.FullName);
        }
        ...
        public static void AddImageContent(IList<object> qiContent, string url)
        {
            ...
            var screen = Screen.FromHandle(new IntPtr(ZenCodingPackage.DTE.ActiveWindow.HWnd));
