...
namespace MadsKristensen.EditorExtensions
{
    public static class FileHelpers
    {
        ...
        public static void OpenFileInPreviewTab(string file)
        {
            ...
            try
            {
                IVsUIShellOpenDocument3 openDoc3 = ZenCodingPackage.GetGlobalService<SVsUIShellOpenDocument>() as IVsUIShellOpenDocument3;
                ...
                ZenCodingPackage.DTE.ItemOperations.OpenFile(file);
            }
            finally
            {
        ...
        {
            var initialPath = Path.GetDirectoryName(ZenCodingPackage.DTE.ActiveDocument.FullName);
        ...
        {
            Find2 find = (Find2)ZenCodingPackage.DTE.Find;
