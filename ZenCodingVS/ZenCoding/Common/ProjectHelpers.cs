...
namespace MadsKristensen.EditorExtensions
{
    internal static class ProjectHelpers
    {
        ...
        {
            Solution2 solution = ZenCodingPackage.DTE.Solution as Solution2;
        ...
        {
            return ZenCodingPackage.DTE.Solution.Projects
                  .Cast<Project>()
                  .SelectMany(GetChildProjects)
                  .Union(ZenCodingPackage.DTE.Solution.Projects.Cast<Project>())
        ...
        public static string GetRootFolder(Project project = null)
        {
            try
            {
                ...
                {
                    var doc = ZenCodingPackage.DTE.ActiveDocument;
        ...
        public static Project GetActiveProject()
        {
            try
            {
                Array activeSolutionProjects = ZenCodingPackage.DTE.ActiveSolutionProjects as Array;
        ...
        {
            return (IComponentModel)ZenCodingPackage.GetGlobalService(typeof(SComponentModel));
        }
        ...
        {
            var items = (Array)(dte ?? ZenCodingPackage.DTE).ToolWindows.SolutionExplorer.SelectedItems;
        ...
        {
            var items = (Array)ZenCodingPackage.DTE.ToolWindows.SolutionExplorer.SelectedItems;
            foreach (UIHierarchyItem selItem in items)
            {
        ...
        {
            EnvDTE.Solution solution = ZenCodingPackage.DTE.Solution;
        ...
        internal static ProjectItem GetProjectItem(string fileName)
        {
            try
            {
                return ZenCodingPackage.DTE.Solution.FindProjectItem(fileName);
            }
