...
namespace SteveCadwallader.CodeMaid.Logic.Cleaning
{
    ...
    /// </summary>
    /// <remarks>
    /// /// Note: All POSIXRegEx text replacements
    /// search against '\n' but insert/replace with
    /// Environment.NewLine. This handles line
    /// endings correctly.
    /// </remarks>
    internal class CodeCleanupManager
    {
        ...
        private readonly HtmlTagFormatLogic _htmlTagFormatLogic;
        ...
        private CodeCleanupManager(CodeMaidPackage package)
        {
            ...
            _htmlTagFormatLogic = HtmlTagFormatLogic.GetInstance(_package);
        }
        ...
        internal void Cleanup(ProjectItem projectItem)
        {
            ...
            if (!wasOpen)
            {
                ...
                {
                    // OK if file cannot be opened
                    // (ex: deleted from disk,
                    // non-text based type.)
                }
            }
        ...
        /// <summary>
        /// Finds a code cleanup method appropriate
        /// for the specified document, otherwise null.
        /// </summary>
        /// <param name="document">The document.</param>
        /// <returns>
        /// The code cleanup method, otherwise null.
        /// </returns>
        ...
        /// <summary>
        /// Attempts to run code cleanup on the
        /// specified CSharp document.
        /// </summary>
        /// <param name="document">
        /// The document for cleanup.
        /// </param>
        private void RunCodeCleanupCSharp(Document document)
        {
            var textDocument = document.GetTextDocument();

            // Perform any actions that can modify
            // the file code model first.
            ...
            // Perform insertion of blank line
            // padding cleanup.
            ...
            // Perform insertion of explicit access
            // modifier cleanup.
        ...
        /// <summary 该方法是对html, xaml,xml文件进行清理格式化的>
        /// Attempts to run code cleanup on the
        /// specified markup document. </summary>
        /// <param name="document">The document for cleanup.</param>
        private void RunCodeCleanupMarkup(Document document)
        {
            var textDocument = document.GetTextDocument();
             //格式aspx文件的html标签
            _htmlTagFormatLogic.HtmlTagFormat(textDocument);
        ...
        /// <summary>
        /// Runs external formatting tools (e.g.
        /// Visual Studio, JetBrains ReSharper,
        /// Telerik JustCode).
        /// </summary>
        /// <param name="textDocument">
        /// The text document to cleanup.
        /// </param>
        ...
        /// <summary>
        /// Runs the Visual Studio built-in format
        /// document command.
        /// </summary>
        /// <param name="textDocument">
        /// The text document to cleanup.
        ...
        private void RunJetBrainsReSharperCleanup(TextDocument textDocument)
        {
            ...
            // This command changed to include the
            // leading 'ReSharper.' in version
            // 2016.1. Execute both commands for
