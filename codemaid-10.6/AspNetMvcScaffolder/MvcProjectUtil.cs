...
namespace AspNetMvcScaffolder
{
    internal static class MvcProjectUtil
    {
        ...
        public const string ServiceTypeSuffix = "Service";
        public const string ViewModelSuffix = "Model";
        ...
        public const string ViewModelNameRegex = @"\b([_\d\w]*)" + ViewModelSuffix + "$";

        public const string ServiceTypeNameRegex = @"\bI([_\d\w]*)" + ServiceTypeSuffix + "$";
