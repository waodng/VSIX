...
namespace AspNetMvcScaffolder.UserInterface
{
    public class ValidatingDialogWindow : VSPlatformDialogWindow
    {
        ...
        private static readonly DependencyProperty DialogHostProperty = DependencyProperty.Register("DialogHost",typeof(IDialogHost),typeof(ValidatingDialogWindow), new PropertyMetadata());
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic",Justification = "We prefer this design, it will be easier to work with in the future if we want to write tests.")]
        ...
        private class ValidatingDialogHost : IDialogHost
        {
            ...
            public void ShowErrorMessage(string message, string caption)
            {
                ...
                VsShellUtilities.ShowMessageBox( Dialog.ServiceProvider, message,caption ?? Dialog.Title,OLEMSGICON.OLEMSGICON_CRITICAL,OLEMSGBUTTON.OLEMSGBUTTON_OK,OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST);
            }
