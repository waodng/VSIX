...
namespace AspNetMvcScaffolder.VisualStudio
{
    ...
    internal class VisualStudioIntegration : IVisualStudioIntegration
    {
        ...
        public void ShowErrorMessage(string caption, string message)
        {
            ...
            VsShellUtilities.ShowMessageBox( ServiceProvider, message,  caption,   OLEMSGICON.OLEMSGICON_CRITICAL,   OLEMSGBUTTON.OLEMSGBUTTON_OK,  OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST);
        }
    }
}
