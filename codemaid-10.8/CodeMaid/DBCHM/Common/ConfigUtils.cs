    ...
    public static class ConfigUtils
    {
        ...
        private static void Init()
        {
            ...
            else
            {
                ...
                var info = db.Info;
                if(!info.IsExistColumn("DBCHMConfig", "DBCHMConfig.Modified"))
                {
                    var configs = db.GetListDictionary("select * from DBCHMConfig");

                    db.Info.DropTable("DBCHMConfig");
                    ...
                    if (configs != null && configs.Count > 0)
                    {
                        ...
                        db.ExecSql("update DBCHMConfig set ConnTimeOut = 120 ");
                    }
                }
            }
        }
