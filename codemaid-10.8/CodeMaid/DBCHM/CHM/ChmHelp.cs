...
namespace Waodng.CodeMaid.DBCHM.CHM
{
    ...
    public class ChmHelp
    {
        ...
        private void CreateHHP()
        {
            ...
            code.AppendLine(string.Format("Default topic={0}",DefaultPage));//CHM文件的首页
            ...
            code.AppendLine(string.Format("Title={0}",Title));//CHM文件标题
            ...
            code.AppendLine(string.Format("Main=\"{0}\",\"chm.hhc\",\"chm.hhk\",\"{1}\",\"{2}\",,,,20000,0x63520,180,0x104E, [0,0,745,509],0x0,0x0,,,,,0", Title, DefaultPage, DefaultPage));
            code.AppendLine();
