namespace SteveCadwallader.CodeMaid
{
    ...
    internal sealed partial class PackageIds
    {
        ...
        //添加关于网站项目节点 waodng
        public const int GroupIDCodeMaidContextWebProjectGroup = 0x105C;
        public const int GroupIDCodeMaidContextWebItemNodeGroup = 0x105D;
        public const int GroupIDCodeMaidContextWebFolderGroup = 0x105E;
        ...
        //新增关于嵌入文件和移出嵌入文件标识
        public const int CmdIDCodeMaidNestInFile = 0x4000;
