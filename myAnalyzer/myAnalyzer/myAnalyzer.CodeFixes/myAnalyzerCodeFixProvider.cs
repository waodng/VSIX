...
namespace myAnalyzer
{
    ...
    public class myAnalyzerCodeFixProvider : CodeFixProvider
    {
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            context.RegisterCodeFix(
                CodeAction.Create(
                    ...
                    createChangedSolution: c => MakeDepartmentIdsAsync(context.Document, declaration, c),
        ...
        /// <returns></returns>
        private async Task<Solution> MakeDepartmentIdsAsync(Document document, TypeDeclarationSyntax typeDecl, CancellationToken cancellationToken)
        {
